...
public class Color {
  ...
  public String getSelectWithRow() {
    Row row = getRow(String.valueOf(this.slot % 9));
    return (row == null) ? this.select : (row.getCharacter() + row.getCharacter());
  }
  ...
  public Row getRow() {
    return getRow(String.valueOf(this.slot % 9));
  }
