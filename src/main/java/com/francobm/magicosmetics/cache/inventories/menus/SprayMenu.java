...
/*     */   public SprayMenu(String id, ContentMenu contentMenu, int startSlot, int endSlot, Set<Integer> backSlot, Set<Integer> nextSlot, int pagesSlot, List<Integer> slotsUnavailable) {
...
/*     */   }
/*     */   
/*     */   public SprayMenu(PlayerData playerData, Menu menu) {
...
/*  38 */     if (slotMenu == null)
/*  39 */       return;  if (slotMenu.getItems().getId().endsWith("_spray") && 
...
/*  65 */       int cosmetics = Cosmetic.getCosmeticCount(CosmeticType.SPRAY);
...
/*  84 */     List<Cosmetic> cosmetics = Cosmetic.getCosmeticsUnHideByType(CosmeticType.SPRAY);
...
/* 113 */         Items items = new Items("" + getPage() + this.index + "_spray", Items.getItem("spray-template").copyItem(this.playerData, cosmetic, cosmetic.getItemStack()));
/*     */         
...
/* 135 */         if (this.playerData.getSpray() != null) {
/* 136 */           if (this.playerData.getSpray().getId().equalsIgnoreCase(cosmetic.getId())) {
...
/* 157 */         setItemInPaginatedMenu(slotMenu, getPage(), this.index, "_spray"); continue;
/*     */       } 
/*     */     } 
...
/* 174 */       setItemInPaginatedMenu(slotMenu, -1, -1, "_spray");
/*     */     }
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\cache\inventories\menus\SprayMenu.class
