  ...
  public void setItems() {
    ...
    if (!cosmetics.isEmpty()) {
      ...
      for (int i = 0; i < getMaxItemsPerPage(); i++) {
        ...
        Items items = new Items("" + getPage() + this.index + "_wstick", Items.getItem("wstick-template").copyItem(this.playerData, cosmetic, cosmetic.getItemStack()));
        ...
        if (this.playerData.getWStick() != null) {
          if (this.playerData.getWStick().getId().equalsIgnoreCase(cosmetic.getId())) {
        ...
        setItemInPaginatedMenu(slotMenu, getPage(), this.index, "_wstick");
        continue;
      } 
    } 
