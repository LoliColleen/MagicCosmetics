  ...
  public void setItems() {
    ...
    if (!cosmetics.isEmpty()) {
      ...
      for (int i = 0; i < getMaxItemsPerPage(); i++) {
        ...
        Items items = new Items("" + getPage() + this.index + "_bag", Items.getItem("bag-template").copyItem(this.playerData, cosmetic, cosmetic.getItemStack()));
        ...
        if (this.playerData.getBag() != null) {
          if (this.playerData.getBag().getId().equalsIgnoreCase(cosmetic.getId())) {
        ...
        setItemInPaginatedMenu(slotMenu, getPage(), this.index, "_bag");
        continue;
      } 
    } 
