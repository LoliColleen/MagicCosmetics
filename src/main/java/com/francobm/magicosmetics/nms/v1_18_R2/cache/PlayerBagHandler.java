...
/*  37 */     this.backPackItem = backPackItem;
/*  38 */     this.backPackItemForMe = backPackItemForMe;
/*  39 */     this.distance = distance;
/*  40 */     this.height = height;
/*  41 */     this.ids = new ArrayList();
...
/*  86 */         this.ids.add(Integer.valueOf(entityAreaEffectCloud.ae()));
/*     */       } 
...
/*     */         } 
/*  95 */       }  addPassenger(player, ((Integer)this.ids.get(this.ids.size() - 1)).intValue(), this.armorStand.ae());
/*     */     } else {
/*  97 */       addPassenger(player, (this.lendEntityId == -1) ? owner.getEntityId() : this.lendEntityId, this.armorStand.ae());
/*     */     } 
...
/* 129 */     List<Packet<?>> backPack = getBackPackMountPacket((this.lendEntityId == -1) ? getPlayer().getEntityId() : this.lendEntityId, this.armorStand.ae());
...
/* 188 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.armorStand.ae(), this.armorStand.ai(), true);
/* 189 */     PacketPlayOutMount mountEntity = new PacketPlayOutMount((Entity)this.entityPlayer);
/* 190 */     PacketPlayOutEntityEquipment equip = new PacketPlayOutEntityEquipment(this.armorStand.ae(), Collections.singletonList(new Pair(EnumItemSlot.f, CraftItemStack.asNMSCopy(backpackItem))));
...
/* 196 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(entityAreaEffectCloud.ae(), entityAreaEffectCloud.ai(), true);
...
/* 202 */     if (!removeClouds) {
/* 203 */       PacketPlayOutEntityDestroy backPackDestroy = new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ae() });
...
/*     */     } 
/* 209 */     packets.add(new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ae() }));
/* 210 */     return packets;
/*     */   }
/*     */   
...
/* 225 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.ae(), list));
/*     */   }
/*     */   
/*     */   private List<Packet<?>> getBackPackHelmetPacket(ArrayList<Pair<EnumItemSlot, ItemStack>> pairs) {
/* 229 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.ae(), pairs));
/*     */   }
/*     */   
...
/* 234 */     PacketPlayOutEntity.PacketPlayOutEntityLook packetPlayOutEntityLook = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.ae(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true);
...
/* 247 */     return playerConnection.a.m.pipeline();
/*     */   }
/*     */   
/*     */   @FunctionalInterface
