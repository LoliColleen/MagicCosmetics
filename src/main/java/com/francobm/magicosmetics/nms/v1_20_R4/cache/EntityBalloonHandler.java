...
/* 181 */     this.CATCH_UP_INCREMENTS_DISTANCE = 0.27D; this.players = new CopyOnWriteArrayList(new ArrayList()); this.uuid = entity.getUniqueId(); this.distance = distance; this.invisibleLeash = invisibleLeash; entitiesBalloon.put(this.uuid, this); this.entity = (LivingEntity)entity; WorldServer world = ((CraftWorld)entity.getWorld()).getHandle(); Location location = entity.getLocation().clone().add(0.0D, space, 0.0D); location = location.clone().add(entity.getLocation().clone().getDirection().multiply(-1)); this.armorStand = new EntityArmorStand(EntityTypes.d, (World)world); this.armorStand.b(location.getX(), location.getY() - 1.3D, location.getZ(), location.getYaw(), location.getPitch()); this.armorStand.k(true); this.armorStand.n(true); this.armorStand.u(true); this.bigHead = bigHead; if (isBigHead()) this.armorStand.d(new Vector3f(this.armorStand.D().b(), 0.0F, 0.0F));  this.leashed = (EntityLiving)new EntityPufferFish(EntityTypes.aF, (World)world); this.leashed.collides = false; this.leashed.k(true); this.leashed.n(true); this.leashed.b(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch()); this.space = space; this.SQUARED_WALKING = 5.5D * space; this.SQUARED_DISTANCE = 10.0D * space;
/*     */   }
/*     */   public void spawn(Player player) { if (this.players.contains(player.getUniqueId())) { if (!getEntity().getWorld().equals(player.getWorld())) { remove(player); return; }  if (getEntity().getLocation().distanceSquared(player.getLocation()) > this.distance) remove(player);  return; }  if (!getEntity().getWorld().equals(player.getWorld())) return;  if (getEntity().getLocation().distanceSquared(player.getLocation()) > this.distance) return;  EntityPlayer entityPlayer = ((CraftPlayer)player).getHandle(); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand)); entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c())); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed)); entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.leashed.al(), this.leashed.ap().c())); if (!this.invisibleLeash) entityPlayer.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle()));  this.players.add(player.getUniqueId()); }
/* 184 */   public void spawn(boolean exception) { for (Player player : Bukkit.getOnlinePlayers()) { if (exception && player.getUniqueId().equals(this.uuid)) continue;  spawn(player); }  } public void remove() { for (UUID uuid : this.players) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.players.remove(uuid); continue; }  remove(player); }  entitiesBalloon.remove(this.uuid); } public void remove(Player player) { PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.al(), this.leashed.al() })); this.players.remove(player.getUniqueId()); } public void update() { if (isBigHead()) {
/* 185 */       updateBigHead();
/*     */       return;
/*     */     } 
...
/* 229 */         this.rot += 0.01D;
/* 230 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() - 0.5F, this.armorStand.A().c(), this.armorStand.A().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 236 */         this.rot -= 0.01D;
/* 237 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + 0.5F, this.armorStand.A().c(), this.armorStand.A().d() + this.rotate));
/*     */         
...
/*     */       }
/* 256 */       p.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
...
/* 264 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() - 0.8F, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */         
...
/* 271 */       this.armorStand.a(new Vector3f(this.armorStand.A().b() + 0.8F, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */       
...
/*     */   public void lookEntity() { float yaw = getEntity().getLocation().getYaw(); for (UUID uuid : this.players) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.players.remove(uuid); continue; }  PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.armorStand, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.al(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.al(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); }
/*     */      }
...
/* 328 */         this.rot += 0.01D;
/*     */         
/* 330 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() - 0.5F, this.armorStand.D().c(), this.armorStand.D().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 336 */         this.rot -= 0.01D;
/* 337 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + 0.5F, this.armorStand.D().c(), this.armorStand.D().d() + this.rotate));
/*     */         
...
/*     */       }
/* 357 */       p.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
...
/* 365 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() - 0.8F, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */         
...
/* 372 */       this.armorStand.d(new Vector3f(this.armorStand.D().b() + 0.8F, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */       
...
/*     */       case RIGHT:
/* 395 */         this.armorStand.a(new Vector3f(this.armorStand.A().b(), this.armorStand.A().c() + rotate, this.armorStand.A().d()));
/*     */         break;
/*     */       case UP:
/* 398 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */         break;
/*     */       case ALL:
/* 401 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c() + rotate, this.armorStand.A().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 410 */       (((CraftPlayer)player).getHandle()).c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
/*     */     } 
/*     */   }
/*     */   
...
/*     */       case RIGHT:
/* 418 */         this.armorStand.d(new Vector3f(this.armorStand.D().b(), this.armorStand.D().c() + rotate, this.armorStand.D().d()));
/*     */         break;
/*     */       case UP:
/* 421 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + rotate, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */         break;
/*     */       case ALL:
/* 424 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + rotate, this.armorStand.D().c() + rotate, this.armorStand.D().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 433 */       (((CraftPlayer)player).getHandle()).c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
/*     */     } 
/*     */   }
/*     */   
