...
public class PlayerBalloonHandler extends PlayerBalloon {
  ...
  public void remove(Player player) {
    ...
    connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.al() }));
    connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.al() }));
    connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.al() }));
