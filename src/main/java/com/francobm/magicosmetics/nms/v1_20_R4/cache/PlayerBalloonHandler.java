...
/* 257 */     this.CATCH_UP_INCREMENTS_DISTANCE = 0.27D; this.viewers = new CopyOnWriteArrayList(new ArrayList()); this.hideViewers = new CopyOnWriteArrayList(new ArrayList()); this.uuid = p.getUniqueId(); this.distance = distance; this.invisibleLeash = invisibleLeash; playerBalloons.put(this.uuid, this); Player player = getPlayer(); WorldServer world = ((CraftWorld)player.getWorld()).getHandle(); Location location = player.getLocation().clone().add(0.0D, space, 0.0D); location = location.clone().add(player.getLocation().clone().getDirection().multiply(-1)); this.armorStand = new EntityArmorStand(EntityTypes.d, (World)world); this.armorStand.b(location.getX(), location.getY() - 1.3D, location.getZ(), location.getYaw(), location.getPitch()); this.armorStand.k(true); this.armorStand.n(true); this.armorStand.u(true); this.bigHead = bigHead; if (isBigHead()) this.armorStand.d(new Vector3f(this.armorStand.D().b(), 0.0F, 0.0F));  this.leashed = (EntityLiving)new EntityPufferFish(EntityTypes.aF, (World)world); this.leashed.collides = false; this.leashed.k(true); this.leashed.n(true); this.leashed.b(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch()); this.space = space; this.SQUARED_WALKING = 5.5D * space; this.SQUARED_DISTANCE = 10.0D * space;
/*     */   }
/*     */   public void spawn(Player player) { if (this.hideViewers.contains(player.getUniqueId())) return;  Player owner = getPlayer(); if (owner == null) return;  if (this.viewers.contains(player.getUniqueId())) { if (!owner.getWorld().equals(player.getWorld())) { remove(player); return; }  if (owner.getLocation().distanceSquared(player.getLocation()) > this.distance) remove(player);  return; }  if (!owner.getWorld().equals(player.getWorld())) return;  if (owner.getLocation().distanceSquared(player.getLocation()) > this.distance) return;  EntityPlayer entityPlayer = ((CraftPlayer)player).getHandle(); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand)); entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c())); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed)); entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.leashed.al(), this.leashed.ap().c())); if (!this.invisibleLeash) entityPlayer.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, (this.lendEntity == null) ? (Entity)((CraftPlayer)owner).getHandle() : (Entity)((CraftLivingEntity)this.lendEntity).getHandle()));  this.viewers.add(player.getUniqueId()); }
/* 260 */   public void spawn(boolean exception) { for (Player player : Bukkit.getOnlinePlayers()) { if (exception && player.getUniqueId().equals(this.uuid)) continue;  spawn(player); }  } public void remove() { for (UUID uuid : this.viewers) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.viewers.remove(uuid); continue; }  remove(player); }  playerBalloons.remove(this.uuid); } public void remove(Player player) { PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.al() })); connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.al() })); connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.al() })); this.viewers.remove(player.getUniqueId()); } public void update(boolean instantFollow) { if (isBigHead()) {
/* 261 */       updateBigHead();
/*     */       return;
/*     */     } 
...
/* 320 */         this.rot += 0.01D;
/* 321 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() - 0.5F, this.armorStand.A().c(), this.armorStand.A().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 327 */         this.rot -= 0.01D;
/* 328 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + 0.5F, this.armorStand.A().c(), this.armorStand.A().d() + this.rotate));
/*     */         
...
/*     */       }
/* 347 */       p.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
...
/* 355 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() - 0.8F, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */         
...
/* 362 */       this.armorStand.a(new Vector3f(this.armorStand.A().b() + 0.8F, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */       
...
/*     */   public void lookEntity(float yaw, float pitch) { for (UUID uuid : this.viewers) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.viewers.remove(uuid); continue; }  PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.armorStand, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.al(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.al(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); }  }
...
/* 423 */         this.rot += 0.01D;
/* 424 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() - 0.5F, this.armorStand.D().c(), this.armorStand.D().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 430 */         this.rot -= 0.01D;
/* 431 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + 0.5F, this.armorStand.D().c(), this.armorStand.D().d() + this.rotate));
/*     */         
...
/*     */       }
/* 450 */       p.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
...
/* 458 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() - 0.8F, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */         
...
/* 465 */       this.armorStand.d(new Vector3f(this.armorStand.D().b() + 0.8F, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */       
...
/*     */       case RIGHT:
/* 488 */         this.armorStand.a(new Vector3f(this.armorStand.A().b(), this.armorStand.A().c() + rotate, this.armorStand.A().d()));
/*     */         break;
/*     */       case UP:
/* 491 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c(), this.armorStand.A().d()));
/*     */         break;
/*     */       case ALL:
/* 494 */         this.armorStand.a(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c() + rotate, this.armorStand.A().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 503 */       (((CraftPlayer)player).getHandle()).c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
/*     */     } 
/*     */   }
/*     */   
...
/*     */       case RIGHT:
/* 511 */         this.armorStand.d(new Vector3f(this.armorStand.D().b(), this.armorStand.D().c() + rotate, this.armorStand.D().d()));
/*     */         break;
/*     */       case UP:
/* 514 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + rotate, this.armorStand.D().c(), this.armorStand.D().d()));
/*     */         break;
/*     */       case ALL:
/* 517 */         this.armorStand.d(new Vector3f(this.armorStand.D().b() + rotate, this.armorStand.D().c() + rotate, this.armorStand.D().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 526 */       (((CraftPlayer)player).getHandle()).c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.al(), this.armorStand.ap().c()));
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R4\cache\PlayerBalloonHandler.class
