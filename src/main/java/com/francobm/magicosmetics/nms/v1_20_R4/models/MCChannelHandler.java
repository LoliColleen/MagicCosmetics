...
/*  50 */         CallUpdateInvEvent(packetPlayOutSetSlot.e(), packetPlayOutSetSlot.f()); 
/*  51 */     } else if (msg instanceof ClientboundBundlePacket) {
/*  52 */       ClientboundBundlePacket packet = (ClientboundBundlePacket)msg;
/*  53 */       for (Packet<?> subPacket : (Iterable<Packet<?>>)packet.b()) {
...
/*  56 */           handleEntitySpawn(otherPacket.b()); continue;
...
/*  59 */           for (IntListIterator<Integer> intListIterator = otherPacket.b().iterator(); intListIterator.hasNext(); ) { int id = ((Integer)intListIterator.next()).intValue();
...
/*  66 */       handleEntitySpawn(otherPacket.b());
...
/*  69 */       for (IntListIterator<Integer> intListIterator = otherPacket.b().iterator(); intListIterator.hasNext(); ) { int id = ((Integer)intListIterator.next()).intValue();
...
/* 119 */     int id = packetPlayOutMount.e();
/* 120 */     int[] ids = packetPlayOutMount.b();
/* 121 */     Entity entity = getEntityAsync(this.player.z(), id);
...
/* 136 */     data.c(id);
/* 137 */     data.a(newIds);
/* 138 */     return (PacketPlayOutMount)PacketPlayOutMount.a.decode(data);
/*     */   }
/*     */   
/*     */   private void handleEntitySpawn(int id) {
/* 142 */     Entity entity = getEntityAsync(this.player.z(), id);
...
/* 152 */     Entity entity = getEntityAsync(this.player.z(), id);
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R4\models\MCChannelHandler.class
