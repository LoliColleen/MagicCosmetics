...
/*  49 */     this.itemFrame = new EntityItemFrame(EntityTypes.ai, (World)world);
...
/*  67 */       return;  this.itemFrame.k(true);
/*  68 */     this.itemFrame.n(true);
...
/* 127 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.itemFrame.al(), this.itemFrame.ap().c());
/* 128 */     return Arrays.asList((Packet<?>[])new Packet[] { (Packet)spawnEntity, (Packet)entityMetadata });
/*     */   }
/*     */   
/*     */   private Packet<?> destroyItemFrame() {
/* 132 */     return (Packet<?>)new PacketPlayOutEntityDestroy(new int[] { this.itemFrame.al() });
/*     */   }
/*     */   
...
/* 152 */         Object[] parameters = { playerConnection.f };
...
/*     */     } 
/*     */     try {
/* 160 */       Field privateNetworkManager = ServerCommonPacketListenerImpl.class.getDeclaredField("e");
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R4\cache\CustomSprayHandler.class
