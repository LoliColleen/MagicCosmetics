...
public class CustomSprayHandler extends CustomSpray {
  ...
  private List<Packet<?>> spawnItemFrame() {
    ...
    PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.itemFrame.af(), this.itemFrame.aj().c());
    return Arrays.asList((Packet<?>[])new Packet[] { (Packet)spawnEntity, (Packet)entityMetadata });
  }
  
  private Packet<?> destroyItemFrame() {
    return (Packet<?>)new PacketPlayOutEntityDestroy(new int[] { this.itemFrame.af() });
  }
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\cache\CustomSprayHandler.class
