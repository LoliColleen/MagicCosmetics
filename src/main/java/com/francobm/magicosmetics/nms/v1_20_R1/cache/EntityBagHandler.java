...
/*  69 */     entityPlayer.c.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand));
/*     */     
/*  71 */     this.armorStand.aj().refresh(entityPlayer);
...
/*     */           });
/* 111 */       entityPlayer.c.a((Packet)packetPlayOutMount); }
/*     */   
/*     */   }
/*     */ 
/*     */   
...
/*     */             return new PacketPlayOutMount(packetDataSerializer);
/*     */           });
/* 132 */       entityPlayer.c.a((Packet)packetPlayOutMount);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*     */           return new PacketPlayOutMount(packetDataSerializer);
/*     */         });
/* 147 */     entityPlayer.c.a((Packet)packetPlayOutMount);
/*     */   }
/*     */ 
/*     */   
/*     */   public void remove(Player player) {
/* 152 */     PlayerConnection connection = (((CraftPlayer)player).getHandle()).c;
/* 153 */     connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.af() }));
...
/* 168 */       connection.a((Packet)new PacketPlayOutEntityEquipment(this.armorStand.af(), list));
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 182 */       connection.a((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.armorStand, (byte)(int)(yaw * 256.0F / 360.0F)));
/* 183 */       connection.a((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.af(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\cache\EntityBagHandler.class
