...
public class EntityBalloonHandler extends EntityBalloon {
  ...
  public void spawn(Player player) {
    ...
    if (!this.invisibleLeash)
      entityPlayer.c.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
  ...
  public void update() {
    ...
    for (UUID uuid : this.players) {
      ...
      if (!this.invisibleLeash)
        p.c.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\cache\EntityBalloonHandler.class
