...
public class PlayerBalloonHandler extends PlayerBalloon {
  ...
  public PlayerBalloonHandler(Player p, double space, double distance, boolean bigHead, boolean invisibleLeash) {
    ...
    if (isBigHead())
      this.armorStand.d(new Vector3f(this.armorStand.A().b(), 0.0F, 0.0F)); 
  ...
  public void spawn(Player player) {
    ...
    entityPlayer.c.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand));
    this.armorStand.aj().refresh(entityPlayer);
    entityPlayer.c.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed));
    this.leashed.aj().refresh(entityPlayer);
    if (!this.invisibleLeash)
      entityPlayer.c.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, (this.lendEntity == null) ? (Entity)((CraftPlayer)owner).getHandle() : (Entity)((CraftLivingEntity)this.lendEntity).getHandle())); 
  ...
  public void remove(Player player) {
    ...
    connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.af() }));
    connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.af() }));
  ...
  public void setItem(ItemStack itemStack) {
    ...
    for (UUID uuid : this.viewers) {
      ...
      PlayerConnection connection = (((CraftPlayer)player).getHandle()).c;
      connection.a((Packet)new PacketPlayOutEntityEquipment(this.armorStand.af(), list));
    } 
  }
  ...
  public void lookEntity(float yaw, float pitch) {
    for (UUID uuid : this.viewers) {
      ...
      connection.a((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.af(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
      connection.a((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F)));
      connection.a((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.af(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
    } 
  }
  
  protected void teleport(Location location) {
    this.leashed.a(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
    this.armorStand.a(location.getX(), location.getY() - 1.3D, location.getZ(), location.getYaw(), location.getPitch());
  }
  ...
  protected void instantUpdate() {
    ...
    if (!this.rotateLoop) {
      this.rot += 0.02D;
      this.armorStand.a(new Vector3f(this.armorStand.x().b() - 0.5F, this.armorStand.x().c(), this.armorStand.x().d() + this.rotate));
      if (this.rot > 0.2D)
    ...
    if (this.heightLoop) {
      this.height -= 0.01D;
      this.armorStand.a(new Vector3f(this.armorStand.x().b() + 0.8F, this.armorStand.x().c(), this.armorStand.x().d()));
      if (this.height < -0.1D)
    ...
    for (UUID uuid : this.viewers) {
      ...
      if (!this.invisibleLeash)
        p.c.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, (this.lendEntity == null) ? (Entity)((CraftPlayer)owner).getHandle() : (Entity)((CraftLivingEntity)this.lendEntity).getHandle())); 
      this.armorStand.aj().refresh(p);
      p.c.a((Packet)new PacketPlayOutEntityTeleport((Entity)this.leashed));
      p.c.a((Packet)new PacketPlayOutEntityTeleport((Entity)this.armorStand));
    } 
  }
  ...
  public void updateBigHead() {
    ...
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      ...
      if (!this.rotateLoop) {
        this.rot += 0.01D;
        this.armorStand.d(new Vector3f(this.armorStand.A().b() - 0.5F, this.armorStand.A().c(), this.armorStand.A().d() + this.rotate));
        if (this.rot > 0.2D)
          this.rotateLoop = true; 
      } else {
        this.rot -= 0.01D;
    ...
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      if (!this.heightLoop) {
        this.height += 0.01D;
        this.armorStand.d(new Vector3f(this.armorStand.A().b() - 0.8F, this.armorStand.A().c(), this.armorStand.A().d()));
        if (this.height > 0.1D)
          this.heightLoop = true; 
      } 
    } else if (this.heightLoop) {
  ...
  public void rotate(boolean rotation, RotationType rotationType, float rotate) {
    ...
    switch (rotationType) {
      case RIGHT:
        this.armorStand.a(new Vector3f(this.armorStand.x().b(), this.armorStand.x().c() + rotate, this.armorStand.x().d()));
        break;
      case UP:
        this.armorStand.a(new Vector3f(this.armorStand.x().b() + rotate, this.armorStand.x().c(), this.armorStand.x().d()));
        break;
      case ALL:
        this.armorStand.a(new Vector3f(this.armorStand.x().b() + rotate, this.armorStand.x().c() + rotate, this.armorStand.x().d()));
        break;
    } 
    for (UUID uuid : this.viewers) {
      Player player = Bukkit.getPlayer(uuid);
      ...
      this.armorStand.aj().refresh(((CraftPlayer)player).getHandle());
    } 
  }
  ...
  public void rotateBigHead(boolean rotation, RotationType rotationType, float rotate) {
    ...
    switch (rotationType) {
      case RIGHT:
        this.armorStand.d(new Vector3f(this.armorStand.A().b(), this.armorStand.A().c() + rotate, this.armorStand.A().d()));
        break;
      case UP:
        this.armorStand.d(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c(), this.armorStand.A().d()));
        break;
      case ALL:
        this.armorStand.d(new Vector3f(this.armorStand.A().b() + rotate, this.armorStand.A().c() + rotate, this.armorStand.A().d()));
        break;
    } 
    for (UUID uuid : this.viewers) {
      Player player = Bukkit.getPlayer(uuid);
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\cache\PlayerBalloonHandler.class
