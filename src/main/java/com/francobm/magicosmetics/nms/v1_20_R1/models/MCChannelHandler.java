...
/*  54 */         if (subPacket instanceof PacketPlayOutNamedEntitySpawn) {
/*  55 */           PacketPlayOutNamedEntitySpawn otherPacket = (PacketPlayOutNamedEntitySpawn)subPacket;
...
/*     */         } 
/*     */       } 
/*  64 */     } else if (msg instanceof PacketPlayOutNamedEntitySpawn) {
/*  65 */       PacketPlayOutNamedEntitySpawn otherPacket = (PacketPlayOutNamedEntitySpawn)msg;
...
/*     */     
/* 102 */     PlayerData playerData = PlayerData.getPlayer((OfflinePlayer)this.player.getBukkitEntity());
/* 103 */     if (playerData.isZone())
/* 104 */       return;  if (slot == 5) {
/* 105 */       Hat hat = playerData.getHat();
/* 106 */       if (hat == null)
/* 107 */         return;  event = new CosmeticInventoryUpdateEvent((Player)this.player.getBukkitEntity(), CosmeticType.HAT, (Cosmetic)hat, CraftItemStack.asBukkitCopy(itemStack));
/* 108 */     } else if (slot == 45) {
...
/* 119 */     int id = packetPlayOutMount.c();
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\models\MCChannelHandler.class
