...
/*  73 */       p.c.a((Packet)packetPlayOutGameStateChange);
...
/* 161 */       PlayerConnection connection = (((CraftPlayer)p).getHandle()).c;
...
/*     */       case 1:
/* 173 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.a, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 2:
/* 176 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.b, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 3:
/* 179 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.c, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 4:
/* 182 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.d, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 5:
/* 185 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.e, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 6:
/* 188 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bR.j, Containers.f, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */     } 
/* 191 */     if (packet == null)
/* 192 */       return;  entityPlayer.c.a((Packet)packet);
/* 193 */     entityPlayer.bR.b();
/*     */   }
/*     */ 
/*     */   
...
/* 200 */     entityPlayer.c.a((Packet)new PacketPlayOutCamera(e));
/*     */   }
/*     */ 
/*     */   
...
/* 207 */     itemCosmetic.w().a("magic_cosmetic", key);
...
/* 215 */     return itemCosmetic.w().l("magic_cosmetic");
/*     */   }
/*     */   
...
/* 240 */       view.c.a((Packet)packet);
/* 241 */       view.c.a((Packet)metadata);
/*     */     } 
/*     */   }
/*     */   
...
/* 300 */     if (!copy.u()) return itemStack; 
/* 301 */     ItemStack realItem = CraftItemStack.asNMSCopy(itemStack);
/* 302 */     if (!realItem.u()) return itemStack; 
/* 303 */     for (String key : copy.v().e()) {
/* 304 */       if (key.equals("display") || key.equals("CustomModelData"))
/* 305 */         continue;  if (key.equals("PublicBukkitValues")) {
/* 306 */         NBTTagCompound compound = copy.v().p(key);
/* 307 */         NBTTagCompound realCompound = realItem.v().p(key);
...
/*     */         } 
/* 313 */         realItem.v().a(key, (NBTBase)realCompound);
/*     */         continue;
/*     */       } 
/* 316 */       if (!realItem.v().e(key))
/* 317 */         continue;  realItem.v().a(key, copy.v().c(key));
/*     */     } 
...
/* 351 */     PlayerChunkMap.EntityTracker trackedEntity = (PlayerChunkMap.EntityTracker)(level.k()).a.K.get(entity.getEntityId());
/* 352 */     return (IRangeManager)new RangeManager(trackedEntity);
/*     */   }
/*     */ }


/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R1\VersionHandler.class
