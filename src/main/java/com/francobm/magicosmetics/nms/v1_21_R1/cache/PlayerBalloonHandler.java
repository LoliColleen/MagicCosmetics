...
public class PlayerBalloonHandler extends PlayerBalloon {
  ...
  public void spawn(Player player) {
    ...
    entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand, 0, CraftLocation.toBlockPosition(this.armorStand.getBukkitEntity().getLocation())));
    entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.an(), this.armorStand.ar().c()));
    entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed, 0, CraftLocation.toBlockPosition(this.leashed.getBukkitEntity().getLocation())));
    entityPlayer.c.b((Packet)new PacketPlayOutEntityMetadata(this.leashed.an(), this.leashed.ar().c()));
  ...
  public void remove(Player player) {
    ...
    connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.an() }));
    connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.an() }));
  ...
  public void lookEntity(float yaw, float pitch) {
    for (UUID uuid : this.viewers) {
      ...
      connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.an(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
    } 
  }
  ...
  protected void instantUpdate() {
    ...
    for (UUID uuid : this.viewers) {
      ...
      p.c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.an(), this.armorStand.ar().c()));
  ...
  public void rotate(boolean rotation, RotationType rotationType, float rotate) {
    ...
    for (UUID uuid : this.viewers) {
      ...
      (((CraftPlayer)player).getHandle()).c.b((Packet)new PacketPlayOutEntityMetadata(this.armorStand.an(), this.armorStand.ar().c()));
    } 
  }
