...
/*  56 */     this.backpackId = this.armorStand.an();
...
/*  58 */     this.armorStand.k(true);
/*  59 */     this.armorStand.n(true);
/*  60 */     this.armorStand.v(true);
/*     */   }
...
/*  89 */         EntityAreaEffectCloud entityAreaEffectCloud = new EntityAreaEffectCloud(EntityTypes.b, (World)((CraftWorld)player.getWorld()).getHandle());
/*  90 */         entityAreaEffectCloud.a(0.0F);
/*  91 */         entityAreaEffectCloud.k(true);
...
/*  94 */         this.ids.add(Integer.valueOf(entityAreaEffectCloud.an()));
/*     */       } 
...
/*     */         } 
/* 103 */       }  addPassenger(player, ((Integer)this.ids.get(this.ids.size() - 1)).intValue(), this.armorStand.an());
/*     */     } else {
/* 105 */       addPassenger(player, (this.lendEntityId == -1) ? owner.getEntityId() : this.lendEntityId, this.armorStand.an());
/*     */     } 
...
/* 137 */     List<Packet<?>> backPack = getBackPackMountPacket((this.lendEntityId == -1) ? getPlayer().getEntityId() : this.lendEntityId, this.armorStand.an());
...
/* 155 */     PacketPlayOutSpawnEntity spawnEntity = new PacketPlayOutSpawnEntity((Entity)this.armorStand, 0, CraftLocation.toBlockPosition(this.entityPlayer.getBukkitEntity().getLocation()));
/* 156 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.armorStand.an(), this.armorStand.ar().c());
/* 157 */     PacketPlayOutEntityEquipment equip = new PacketPlayOutEntityEquipment(this.armorStand.an(), Collections.singletonList(new Pair(EnumItemSlot.f, CraftItemStack.asNMSCopy(backpackItem))));
/* 158 */     PacketPlayOutMount mountEntity = new PacketPlayOutMount((Entity)this.entityPlayer);
...
/* 163 */     PacketPlayOutSpawnEntity spawnEntity = new PacketPlayOutSpawnEntity((Entity)entityAreaEffectCloud, 0, CraftLocation.toBlockPosition(entityAreaEffectCloud.getBukkitEntity().getLocation()));
/* 164 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(entityAreaEffectCloud.an(), entityAreaEffectCloud.ar().c());
...
/* 170 */     if (!removeClouds) {
/* 171 */       PacketPlayOutEntityDestroy backPackDestroy = new PacketPlayOutEntityDestroy(new int[] { this.armorStand.an() });
...
/*     */     } 
/* 177 */     packets.add(new PacketPlayOutEntityDestroy(new int[] { this.armorStand.an() }));
/* 178 */     return packets;
/*     */   }
/*     */   
...
/* 193 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.an(), list));
/*     */   }
/*     */   
/*     */   private List<Packet<?>> getBackPackHelmetPacket(ArrayList<Pair<EnumItemSlot, ItemStack>> pairs) {
/* 197 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.an(), pairs));
/*     */   }
/*     */ 
/*     */   
...
/* 242 */     PacketPlayOutEntity.PacketPlayOutEntityLook packetPlayOutEntityLook = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.an(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true);
...
/* 257 */       String className = "com.denizenscript.denizen.nms.v1_21.impl.network.handlers.DenizenNetworkManagerImpl";
...
/* 263 */         Object[] parameters = { playerConnection.f };
...
/*     */     } 
/*     */     try {
/* 272 */       Field privateNetworkManager = ServerCommonPacketListenerImpl.class.getDeclaredField("e");
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_21_R1\cache\PlayerBagHandler.class
