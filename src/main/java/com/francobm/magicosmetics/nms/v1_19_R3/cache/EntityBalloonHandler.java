...
public class EntityBalloonHandler extends EntityBalloon {
  ...
  public void spawn(Player player) {
    ...
    entityPlayer.b.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand));
    this.armorStand.aj().refresh(entityPlayer);
    entityPlayer.b.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed));
    this.leashed.aj().refresh(entityPlayer);
    if (!this.invisibleLeash)
      entityPlayer.b.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
  ...
  public void update() {
    ...
    for (UUID uuid : this.players) {
      ...
      if (!this.invisibleLeash)
        p.b.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
