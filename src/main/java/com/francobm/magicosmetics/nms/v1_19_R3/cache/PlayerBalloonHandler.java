...
public class PlayerBalloonHandler extends PlayerBalloon {
  ...
  public void spawn(Player player) {
    ...
    if (!this.invisibleLeash)
      entityPlayer.b.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, (this.lendEntity == null) ? (Entity)((CraftPlayer)owner).getHandle() : (Entity)((CraftLivingEntity)this.lendEntity).getHandle())); 
