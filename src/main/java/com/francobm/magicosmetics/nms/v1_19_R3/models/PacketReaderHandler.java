...
/* 23 */     ChannelPipeline pipeline = getPrivateChannelPipeline(entityPlayer.b);
/* 24 */     if (pipeline == null)
...
/* 35 */     Channel channel = getPrivateChannel((craftPlayer.getHandle()).b);
/* 36 */     if (channel == null)
...
/* 45 */       String className = "com.denizenscript.denizen.nms.v1_19.impl.network.handlers.DenizenNetworkManagerImpl";
...
/* 73 */       String className = "com.denizenscript.denizen.nms.v1_19.impl.network.handlers.DenizenNetworkManagerImpl";
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_19_R3\models\PacketReaderHandler.class
