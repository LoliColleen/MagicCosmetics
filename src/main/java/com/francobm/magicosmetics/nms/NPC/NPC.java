...
/*    */ {
/* 14 */   public static Map<UUID, NPC> npcs = new HashMap<>();
...
/* 21 */   protected double height = 0.0D;
/*    */   protected boolean heightLoop = true;
/* 23 */   protected float rotate = -0.4F;
/* 24 */   protected double rot = 0.0D;
...
/* 55 */     npcs.put(player.getUniqueId(), npc);
/*    */   }
/*    */   
...
/* 65 */     return this.punch;
/*    */   }
/*    */   
/*    */   public boolean isBigHead() {
/* 69 */     return this.bigHead;
/*    */   }
/*    */ }
