...
/*  68 */       list.add(new PacketPlayOutPlayerInfo.PlayerInfoData(p.getBukkitEntity().getProfile(), 0, EnumGamemode.b, p.J(), null));
...
/* 112 */     return (PlayerBag)new PlayerBagHandler(player, createRangeManager((Entity)player), distance, height, backPackItem, backPackItemForMe);
/*     */   }
/*     */ 
/*     */   
...
/*     */       case 1:
/* 172 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.a, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 2:
/* 175 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.b, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 3:
/* 178 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.c, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 4:
/* 181 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.d, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 5:
/* 184 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.e, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */       case 6:
/* 187 */         packet = new PacketPlayOutOpenWindow(entityPlayer.bU.j, Containers.f, CraftChatMessage.fromStringOrNull(title));
/*     */         break;
/*     */     } 
/* 190 */     if (packet == null)
/* 191 */       return;  entityPlayer.b.a((Packet)packet);
/* 192 */     entityPlayer.bU.b();
/*     */   }
/*     */ 
/*     */   
...
/* 206 */     itemCosmetic.v().a("magic_cosmetic", key);
...
/* 214 */     return itemCosmetic.v().l("magic_cosmetic");
/*     */   }
/*     */ 
/*     */   
/*     */   public PufferFish spawnFakePuffer(Location location) {
/* 219 */     EntityPufferFish entityPufferFish = new EntityPufferFish(EntityTypes.aw, (World)((CraftWorld)location.getWorld()).getHandle());
...
/* 236 */     PacketPlayOutSpawnEntity packet = new PacketPlayOutSpawnEntity(entityClient);
...
/* 304 */     if (!copy.t()) return itemStack; 
/* 305 */     ItemStack realItem = CraftItemStack.asNMSCopy(itemStack);
/* 306 */     if (!realItem.t()) return itemStack; 
/* 307 */     for (String key : copy.u().d()) {
/* 308 */       if (key.equals("display") || key.equals("CustomModelData"))
/* 309 */         continue;  if (key.equals("PublicBukkitValues")) {
/* 310 */         NBTTagCompound compound = copy.u().p(key);
/* 311 */         NBTTagCompound realCompound = realItem.u().p(key);
...
/*     */         } 
/* 317 */         realItem.u().a(key, (NBTBase)realCompound);
/*     */         continue;
/*     */       } 
/* 320 */       if (!realItem.u().e(key))
/* 321 */         continue;  realItem.u().a(key, copy.u().c(key));
/*     */     } 
...
/* 355 */     PlayerChunkMap.EntityTracker trackedEntity = (PlayerChunkMap.EntityTracker)(level.k()).a.K.get(entity.getEntityId());
/* 356 */     return (IRangeManager)new RangeManager(trackedEntity);
/*     */   }
/*     */ }


/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_19_R1\VersionHandler.class
