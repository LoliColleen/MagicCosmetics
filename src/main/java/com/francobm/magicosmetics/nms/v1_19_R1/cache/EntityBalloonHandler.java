...
public class EntityBalloonHandler extends EntityBalloon {
  ...
  public EntityBalloonHandler(Entity entity, double space, double distance, boolean bigHead, boolean invisibleLeash) {
    ...
    this.leashed = (EntityLiving)new EntityPufferFish(EntityTypes.aw, (World)world);
  ...
  public void spawn(Player player) {
    ...
    connection.a((Packet)new PacketPlayOutSpawnEntity((EntityLiving)this.armorStand));
    connection.a((Packet)new PacketPlayOutEntityMetadata(this.armorStand.ae(), this.armorStand.ai(), true));
    connection.a((Packet)new PacketPlayOutSpawnEntity(this.leashed));
    connection.a((Packet)new PacketPlayOutEntityMetadata(this.leashed.ae(), this.leashed.ai(), true));
    if (!this.invisibleLeash)
      connection.a((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
