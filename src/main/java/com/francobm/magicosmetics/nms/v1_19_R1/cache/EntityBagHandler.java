...
public class EntityBagHandler extends EntityBag {
  ...
  public void spawnBag(Player player) {
    ...
    DataWatcher watcher = this.armorStand.ai();
    watcher.b(new DataWatcherObject(0, DataWatcherRegistry.a), Byte.valueOf((byte)32));
    connection.a((Packet)new PacketPlayOutEntityMetadata(this.armorStand.ae(), watcher, true));
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_19_R1\cache\EntityBagHandler.class
