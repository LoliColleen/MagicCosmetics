...
/*  69 */       list.add(new ClientboundPlayerInfoUpdatePacket.b(player.getUniqueId(), p.getBukkitEntity().getProfile(), false, 0, EnumGamemode.b, p.N(), null));
...
/* 218 */     EntityPufferFish entityPufferFish = new EntityPufferFish(EntityTypes.aC, (World)((CraftWorld)location.getWorld()).getHandle());
...
/* 233 */     DataWatcher dataWatcher = entityClient.an();
...
/*     */     
/*     */     try {
/* 352 */       trackedEntity = (PlayerChunkMap.EntityTracker)(level.l()).a.K.get(entity.getEntityId());
/* 353 */     } catch (NoSuchFieldError var8) {
/* 354 */       Entity nmsEntity = ((CraftEntity)entity).getHandle();
/*     */       
/*     */       try {
/* 357 */         Field trackerField = nmsEntity.getClass().getField("tracker");
/* 358 */         trackedEntity = (PlayerChunkMap.EntityTracker)trackerField.get(nmsEntity);
/* 359 */       } catch (IllegalAccessException|NoSuchFieldException var7) {
/* 360 */         throw new RuntimeException(var7);
/*     */       } 
/*     */     } 
/*     */     
/* 364 */     return (IRangeManager)new RangeManager(trackedEntity);
/*     */   }
/*     */ }
