...
/* 320 */         this.rot += 0.01D;
/* 321 */         this.armorStand.a(new Vector3f(this.armorStand.B().b() - 0.5F, this.armorStand.B().c(), this.armorStand.B().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 327 */         this.rot -= 0.01D;
/* 328 */         this.armorStand.a(new Vector3f(this.armorStand.B().b() + 0.5F, this.armorStand.B().c(), this.armorStand.B().d() + this.rotate));
/*     */         
...
/*     */       }
/* 347 */       this.armorStand.an().refresh(p);
...
/* 355 */         this.armorStand.a(new Vector3f(this.armorStand.B().b() - 0.8F, this.armorStand.B().c(), this.armorStand.B().d()));
/*     */         
...
/* 362 */       this.armorStand.a(new Vector3f(this.armorStand.B().b() + 0.8F, this.armorStand.B().c(), this.armorStand.B().d()));
/*     */       
...
/*     */   public void lookEntity(float yaw, float pitch) { for (UUID uuid : this.viewers) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.viewers.remove(uuid); continue; }  PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.armorStand, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.aj(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.aj(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); }  }
...
/* 377 */   protected void instantUpdate() { Player owner = getPlayer(); if (owner == null) return;  if (this.armorStand == null) return;  if (this.leashed == null) return;  if (!owner.getWorld().equals(this.leashed.getBukkitEntity().getWorld())) { spawn(false); return; }  Location playerLoc = owner.getLocation().clone().add(0.0D, this.space, 0.0D); Location stand = this.leashed.getBukkitEntity().getLocation().clone(); Vector standDir = owner.getEyeLocation().clone().subtract(stand).toVector(); if (!standDir.equals(new Vector())) standDir.normalize();  Location standToLoc = playerLoc.setDirection(standDir.setY(2)); if (!this.floatLoop) { this.y += 0.01D; standToLoc.add(0.0D, 0.01D, 0.0D); if (this.y > 0.1D) this.floatLoop = true;  } else { this.y -= 0.01D; standToLoc.subtract(0.0D, 0.01D, 0.0D); if (this.y < -0.11D) { this.floatLoop = false; this.rotate *= -1.0F; }  }  teleport(standToLoc); if (!this.rotateLoop) { this.rot += 0.02D; this.armorStand.a(new Vector3f(this.armorStand.B().b() - 0.5F, this.armorStand.B().c(), this.armorStand.B().d() + this.rotate)); if (this.rot > 0.2D) this.rotateLoop = true;  } else { this.rot -= 0.02D; this.armorStand.a(new Vector3f(this.armorStand.B().b() + 0.5F, this.armorStand.B().c(), this.armorStand.B().d() + this.rotate)); if (this.rot < -0.2D) this.rotateLoop = false;  }  if (this.heightLoop) { this.height -= 0.01D; this.armorStand.a(new Vector3f(this.armorStand.B().b() + 0.8F, this.armorStand.B().c(), this.armorStand.B().d())); if (this.height < -0.1D) this.heightLoop = false;  return; }  for (UUID uuid : this.viewers) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.viewers.remove(uuid); continue; }  EntityPlayer p = ((CraftPlayer)player).getHandle(); if (!this.invisibleLeash) p.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, (this.lendEntity == null) ? (Entity)((CraftPlayer)owner).getHandle() : (Entity)((CraftLivingEntity)this.lendEntity).getHandle()));  this.armorStand.an().refresh(p); p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.leashed)); p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.armorStand)); }  } public void updateBigHead() { Player owner = getPlayer();
/* 378 */     if (owner == null)
...
/*     */       }
/* 450 */       this.armorStand.an().refresh(p);
...
/*     */       case RIGHT:
/* 488 */         this.armorStand.a(new Vector3f(this.armorStand.B().b(), this.armorStand.B().c() + rotate, this.armorStand.B().d()));
/*     */         break;
/*     */       case UP:
/* 491 */         this.armorStand.a(new Vector3f(this.armorStand.B().b() + rotate, this.armorStand.B().c(), this.armorStand.B().d()));
/*     */         break;
/*     */       case ALL:
/* 494 */         this.armorStand.a(new Vector3f(this.armorStand.B().b() + rotate, this.armorStand.B().c() + rotate, this.armorStand.B().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 503 */       this.armorStand.an().refresh(((CraftPlayer)player).getHandle());
/*     */     } 
/*     */   }
/*     */   
...
/*     */         continue;
/*     */       } 
/* 526 */       this.armorStand.an().refresh(((CraftPlayer)player).getHandle());
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R3\cache\PlayerBalloonHandler.class
