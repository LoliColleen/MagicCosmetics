...
/*     */     
/*  71 */     this.armorStand.al().refresh(entityPlayer);
...
/* 153 */     connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ah() }));
...
/* 168 */       connection.b((Packet)new PacketPlayOutEntityEquipment(this.armorStand.ah(), list));
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 183 */       connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
/*     */     } 
/*     */   }
/*     */   
