...
/*  55 */     this.backpackId = this.armorStand.ah();
...
/*  57 */     this.armorStand.j(true);
/*  58 */     this.armorStand.m(true);
...
/*  88 */         EntityAreaEffectCloud entityAreaEffectCloud = new EntityAreaEffectCloud(EntityTypes.c, (World)((CraftWorld)player.getWorld()).getHandle());
/*  89 */         entityAreaEffectCloud.a(0.0F);
/*  90 */         entityAreaEffectCloud.j(true);
...
/*  93 */         this.ids.add(Integer.valueOf(entityAreaEffectCloud.ah()));
/*     */       } 
...
/*     */         } 
/* 102 */       }  addPassenger(player, ((Integer)this.ids.get(this.ids.size() - 1)).intValue(), this.armorStand.ah());
/*     */     } else {
/* 104 */       addPassenger(player, (this.lendEntityId == -1) ? owner.getEntityId() : this.lendEntityId, this.armorStand.ah());
/*     */     } 
...
/* 136 */     List<Packet<?>> backPack = getBackPackMountPacket((this.lendEntityId == -1) ? getPlayer().getEntityId() : this.lendEntityId, this.armorStand.ah());
...
/* 155 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.armorStand.ah(), this.armorStand.al().c());
/* 156 */     PacketPlayOutMount mountEntity = new PacketPlayOutMount((Entity)this.entityPlayer);
/* 157 */     PacketPlayOutEntityEquipment equip = new PacketPlayOutEntityEquipment(this.armorStand.ah(), Collections.singletonList(new Pair(EnumItemSlot.f, CraftItemStack.asNMSCopy(backpackItem))));
...
/* 163 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(entityAreaEffectCloud.ah(), entityAreaEffectCloud.al().c());
...
/* 169 */     if (!removeClouds) {
/* 170 */       PacketPlayOutEntityDestroy backPackDestroy = new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ah() });
...
/*     */     } 
/* 176 */     packets.add(new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ah() }));
/* 177 */     return packets;
/*     */   }
/*     */   
...
/* 192 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.ah(), list));
/*     */   }
/*     */   
/*     */   private List<Packet<?>> getBackPackHelmetPacket(ArrayList<Pair<EnumItemSlot, ItemStack>> pairs) {
/* 196 */     return (List)Collections.singletonList(new PacketPlayOutEntityEquipment(this.armorStand.ah(), pairs));
/*     */   }
/*     */ 
/*     */   
...
/* 241 */     PacketPlayOutEntity.PacketPlayOutEntityLook packetPlayOutEntityLook = new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true);
...
/* 262 */         Object[] parameters = { playerConnection.e };
...
/*     */     } 
/*     */     try {
/* 271 */       Field privateNetworkManager = ServerCommonPacketListenerImpl.class.getDeclaredField("c");
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R2\cache\PlayerBagHandler.class
