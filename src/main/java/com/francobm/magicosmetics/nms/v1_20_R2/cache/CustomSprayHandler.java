...
/*  49 */     this.itemFrame = new EntityItemFrame(EntityTypes.af, (World)world);
...
/* 127 */     PacketPlayOutEntityMetadata entityMetadata = new PacketPlayOutEntityMetadata(this.itemFrame.ah(), this.itemFrame.al().c());
/* 128 */     return Arrays.asList((Packet<?>[])new Packet[] { (Packet)spawnEntity, (Packet)entityMetadata });
/*     */   }
/*     */   
/*     */   private Packet<?> destroyItemFrame() {
/* 132 */     return (Packet<?>)new PacketPlayOutEntityDestroy(new int[] { this.itemFrame.ah() });
/*     */   }
/*     */   
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_20_R2\cache\CustomSprayHandler.class
