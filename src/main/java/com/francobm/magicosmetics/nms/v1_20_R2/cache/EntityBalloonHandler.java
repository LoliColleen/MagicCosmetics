...
/* 182 */     this.CATCH_UP_INCREMENTS_DISTANCE = 0.27D; this.players = new CopyOnWriteArrayList(new ArrayList()); this.uuid = entity.getUniqueId(); this.distance = distance; this.invisibleLeash = invisibleLeash; entitiesBalloon.put(this.uuid, this); this.entity = (LivingEntity)entity; WorldServer world = ((CraftWorld)entity.getWorld()).getHandle(); Location location = entity.getLocation().clone().add(0.0D, space, 0.0D); location = location.clone().add(entity.getLocation().clone().getDirection().multiply(-1)); this.armorStand = new EntityArmorStand(EntityTypes.d, (World)world); this.armorStand.b(location.getX(), location.getY() - 1.3D, location.getZ(), location.getYaw(), location.getPitch()); this.armorStand.j(true); this.armorStand.m(true); this.armorStand.u(true); this.bigHead = bigHead; if (isBigHead()) this.armorStand.d(new Vector3f(this.armorStand.C().b(), 0.0F, 0.0F));  this.leashed = (EntityLiving)new EntityPufferFish(EntityTypes.aB, (World)world); this.leashed.collides = false; this.leashed.j(true); this.leashed.m(true); this.leashed.b(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch()); this.space = space; this.SQUARED_WALKING = 5.5D * space; this.SQUARED_DISTANCE = 10.0D * space;
/*     */   }
/*     */   public void spawn(Player player) { if (this.players.contains(player.getUniqueId())) { if (!getEntity().getWorld().equals(player.getWorld())) { remove(player); return; }  if (getEntity().getLocation().distanceSquared(player.getLocation()) > this.distance) remove(player);  return; }  if (!getEntity().getWorld().equals(player.getWorld())) return;  if (getEntity().getLocation().distanceSquared(player.getLocation()) > this.distance) return;  EntityPlayer entityPlayer = ((CraftPlayer)player).getHandle(); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.armorStand)); this.armorStand.al().refresh(entityPlayer); entityPlayer.c.b((Packet)new PacketPlayOutSpawnEntity((Entity)this.leashed)); this.leashed.al().refresh(entityPlayer); if (!this.invisibleLeash) entityPlayer.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle()));  this.players.add(player.getUniqueId()); }
/* 185 */   public void spawn(boolean exception) { for (Player player : Bukkit.getOnlinePlayers()) { if (exception && player.getUniqueId().equals(this.uuid)) continue;  spawn(player); }  } public void remove() { for (UUID uuid : this.players) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.players.remove(uuid); continue; }  remove(player); }  entitiesBalloon.remove(this.uuid); } public void remove(Player player) { PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ah() })); connection.b((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.ah() })); this.players.remove(player.getUniqueId()); } public void update() { if (isBigHead()) {
/* 186 */       updateBigHead();
/*     */       return;
/*     */     } 
...
/* 230 */         this.rot += 0.01D;
/* 231 */         this.armorStand.a(new Vector3f(this.armorStand.z().b() - 0.5F, this.armorStand.z().c(), this.armorStand.z().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 237 */         this.rot -= 0.01D;
/* 238 */         this.armorStand.a(new Vector3f(this.armorStand.z().b() + 0.5F, this.armorStand.z().c(), this.armorStand.z().d() + this.rotate));
/*     */         
...
/* 255 */         p.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle()));
/*     */       }
/* 257 */       this.armorStand.al().refresh(p);
/* 258 */       p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.leashed));
/* 259 */       p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.armorStand));
/*     */     } 
/*     */     
/* 262 */     if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
/* 263 */       if (!this.heightLoop) {
/* 264 */         this.height += 0.01D;
/* 265 */         this.armorStand.a(new Vector3f(this.armorStand.z().b() - 0.8F, this.armorStand.z().c(), this.armorStand.z().d()));
/*     */         
...
/* 272 */       this.armorStand.a(new Vector3f(this.armorStand.z().b() + 0.8F, this.armorStand.z().c(), this.armorStand.z().d()));
/*     */       
...
/*     */   public void lookEntity() { float yaw = getEntity().getLocation().getYaw(); for (UUID uuid : this.players) { Player player = Bukkit.getPlayer(uuid); if (player == null) { this.players.remove(uuid); continue; }  PlayerConnection connection = (((CraftPlayer)player).getHandle()).c; connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.armorStand, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); connection.b((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F))); connection.b((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true)); }
/*     */      }
/* 287 */   protected void teleport(Location location) { this.leashed.b(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch()); this.armorStand.b(location.getX(), location.getY() - 1.3D, location.getZ(), location.getYaw(), location.getPitch()); } public void updateBigHead() { LivingEntity owner = getEntity();
...
/* 304 */       this.leashed.b(newLocation.getX(), newLocation.getY(), newLocation.getZ(), newLocation.getYaw(), newLocation.getPitch());
/* 305 */       this.armorStand.b(newLocation.getX(), newLocation.getY() - 1.3D, newLocation.getZ(), newLocation.getYaw(), newLocation.getPitch());
/*     */     } else {
...
/* 329 */         this.rot += 0.01D;
/*     */         
/* 331 */         this.armorStand.d(new Vector3f(this.armorStand.C().b() - 0.5F, this.armorStand.C().c(), this.armorStand.C().d() + this.rotate));
/*     */         
...
/*     */       } else {
/* 337 */         this.rot -= 0.01D;
/* 338 */         this.armorStand.d(new Vector3f(this.armorStand.C().b() + 0.5F, this.armorStand.C().c(), this.armorStand.C().d() + this.rotate));
/*     */         
...
/* 345 */       this.leashed.b(newLocation.getX(), newLocation.getY(), newLocation.getZ(), newLocation.getYaw(), newLocation.getPitch());
/* 346 */       this.armorStand.b(newLocation.getX(), newLocation.getY() - 1.3D, newLocation.getZ(), newLocation.getYaw(), newLocation.getPitch());
/*     */     } 
...
/* 356 */         p.c.b((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle()));
/*     */       }
/* 358 */       this.armorStand.al().refresh(p);
/* 359 */       p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.leashed));
/* 360 */       p.c.b((Packet)new PacketPlayOutEntityTeleport((Entity)this.armorStand));
/*     */     } 
/*     */     
/* 363 */     if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
/* 364 */       if (!this.heightLoop) {
/* 365 */         this.height += 0.01D;
/* 366 */         this.armorStand.d(new Vector3f(this.armorStand.C().b() - 0.8F, this.armorStand.C().c(), this.armorStand.C().d()));
/*     */         
...
/* 373 */       this.armorStand.d(new Vector3f(this.armorStand.C().b() + 0.8F, this.armorStand.C().c(), this.armorStand.C().d()));
/*     */       
...
/*     */       case RIGHT:
/* 396 */         this.armorStand.a(new Vector3f(this.armorStand.z().b(), this.armorStand.z().c() + rotate, this.armorStand.z().d()));
/*     */         break;
/*     */       case UP:
/* 399 */         this.armorStand.a(new Vector3f(this.armorStand.z().b() + rotate, this.armorStand.z().c(), this.armorStand.z().d()));
/*     */         break;
/*     */       case ALL:
/* 402 */         this.armorStand.a(new Vector3f(this.armorStand.z().b() + rotate, this.armorStand.z().c() + rotate, this.armorStand.z().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 411 */       this.armorStand.al().refresh(((CraftPlayer)player).getHandle());
/*     */     } 
/*     */   }
/*     */   
...
/*     */       case RIGHT:
/* 419 */         this.armorStand.d(new Vector3f(this.armorStand.C().b(), this.armorStand.C().c() + rotate, this.armorStand.C().d()));
/*     */         break;
/*     */       case UP:
/* 422 */         this.armorStand.d(new Vector3f(this.armorStand.C().b() + rotate, this.armorStand.C().c(), this.armorStand.C().d()));
/*     */         break;
/*     */       case ALL:
/* 425 */         this.armorStand.d(new Vector3f(this.armorStand.C().b() + rotate, this.armorStand.C().c() + rotate, this.armorStand.C().d()));
/*     */         break;
/*     */     } 
...
/*     */         continue;
/*     */       } 
/* 434 */       this.armorStand.al().refresh(((CraftPlayer)player).getHandle());
/*     */     } 
/*     */   }
/*     */   
