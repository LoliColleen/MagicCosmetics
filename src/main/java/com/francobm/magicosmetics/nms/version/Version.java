...
/* 25 */   protected static final UUID RANDOM_UUID = UUID.fromString("92864445-51c5-4c3b-9039-517c9927d1b4");
/*    */   
/*    */   protected PacketReader packetReader;
/*    */ 
/*    */   
/*    */   public PacketReader getPacketReader() {
/* 31 */     return this.packetReader;
/*    */   }
/*    */ 
/*    */   
...
/* 90 */     String decoded = new String(Base64.getDecoder().decode(base64));
/*    */ 
/*    */     
/* 93 */     return new URL(decoded.substring("{\"textures\":{\"SKIN\":{\"url\":\"".length(), decoded.length() - "\"}}}".length()));
/*    */   }
/*    */ }
