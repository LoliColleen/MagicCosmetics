...
/*  94 */     Entity entity = getEntityAsync(this.player.getWorldServer(), id);
...
/* 115 */     Entity entity = getEntityAsync(this.player.getWorldServer(), id);
...
/* 125 */     Entity entity = getEntityAsync(this.player.getWorldServer(), id);
...
/* 135 */     PersistentEntitySectionManager<Entity> entityManager = world.G;
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\francobm\magicosmetics\nms\v1_17_R1\models\MCChannelHandler.class
