...
public class EntityBalloonHandler extends EntityBalloon {
  ...
  public EntityBalloonHandler(Entity entity, double space, double distance, boolean bigHead, boolean invisibleLeash) {
    ...
    if (isBigHead())
      this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX(), 0.0F, 0.0F)); 
  ...
  public void spawn(Player player) {
    ...
    if (!this.invisibleLeash)
      connection.sendPacket((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
  ...
  public void update() {
    ...
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      ...
      if (!this.rotateLoop) {
        this.rot += 0.01D;
        this.armorStand.setHeadPose(new Vector3f(this.armorStand.v().getX() - 0.5F, this.armorStand.v().getY(), this.armorStand.v().getZ() + this.rotate));
        if (this.rot > 0.2D)
    ...
    for (UUID uuid : this.players) {
      ...
      if (!this.invisibleLeash)
        p.b.sendPacket((Packet)new PacketPlayOutAttachEntity((Entity)this.leashed, ((CraftEntity)getEntity()).getHandle())); 
      p.b.sendPacket((Packet)new PacketPlayOutEntityMetadata(this.armorStand.getId(), this.armorStand.getDataWatcher(), true));
      p.b.sendPacket((Packet)new PacketPlayOutEntityTeleport((Entity)this.leashed));
      p.b.sendPacket((Packet)new PacketPlayOutEntityTeleport((Entity)this.armorStand));
    } 
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      if (!this.heightLoop) {
        this.height += 0.01D;
        this.armorStand.setHeadPose(new Vector3f(this.armorStand.v().getX() - 0.8F, this.armorStand.v().getY(), this.armorStand.v().getZ()));
        if (this.height > 0.1D)
  ...
  public void updateBigHead() {
    ...
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      ...
      if (!this.rotateLoop) {
        this.rot += 0.01D;
        this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX() - 0.5F, this.armorStand.cj.getY(), this.armorStand.cj.getZ() + this.rotate));
        if (this.rot > 0.2D)
          this.rotateLoop = true; 
      } else {
        this.rot -= 0.01D;
    ...
    if (distance1.distanceSquared(distance2) > this.SQUARED_WALKING) {
      if (!this.heightLoop) {
        this.height += 0.01D;
        this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX() - 0.8F, this.armorStand.cj.getY(), this.armorStand.cj.getZ()));
        if (this.height > 0.1D)
          this.heightLoop = true; 
      } 
    } else if (this.heightLoop) {
  ...
  public void rotate(boolean rotation, RotationType rotationType, float rotate) {
    ...
    switch (rotationType) {
      case RIGHT:
        this.armorStand.setHeadPose(new Vector3f(this.armorStand.v().getX(), this.armorStand.v().getY() + rotate, this.armorStand.v().getZ()));
        break;
      case UP:
        this.armorStand.setHeadPose(new Vector3f(this.armorStand.v().getX() + rotate, this.armorStand.v().getY(), this.armorStand.v().getZ()));
        break;
      case ALL:
        this.armorStand.setHeadPose(new Vector3f(this.armorStand.v().getX() + rotate, this.armorStand.v().getY() + rotate, this.armorStand.v().getZ()));
        break;
    } 
    for (UUID uuid : this.players) {
      Player player = Bukkit.getPlayer(uuid);
      ...
      (((CraftPlayer)player).getHandle()).b.sendPacket((Packet)new PacketPlayOutEntityMetadata(this.armorStand.getId(), this.armorStand.getDataWatcher(), true));
    } 
  }
  ...
  public void rotateBigHead(boolean rotation, RotationType rotationType, float rotate) {
    ...
    switch (rotationType) {
      case RIGHT:
        this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX(), this.armorStand.cj.getY() + rotate, this.armorStand.cj.getZ()));
        break;
      case UP:
        this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX() + rotate, this.armorStand.cj.getY(), this.armorStand.cj.getZ()));
        break;
      case ALL:
        this.armorStand.setRightArmPose(new Vector3f(this.armorStand.cj.getX() + rotate, this.armorStand.cj.getY() + rotate, this.armorStand.cj.getZ()));
        break;
    } 
    for (UUID uuid : this.players) {
      Player player = Bukkit.getPlayer(uuid);
