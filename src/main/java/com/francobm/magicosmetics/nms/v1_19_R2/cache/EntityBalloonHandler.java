...
public class EntityBalloonHandler extends EntityBalloon {
  ...
  public EntityBalloonHandler(Entity entity, double space, double distance, boolean bigHead, boolean invisibleLeash) {
    ...
    this.leashed = (EntityLiving)new EntityPufferFish(EntityTypes.ax, (World)world);
  ...
  public void remove(Player player) {
    ...
    connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.armorStand.ah() }));
    connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.leashed.ah() }));
  ...
  public void setItem(ItemStack itemStack) {
    ...
    for (UUID uuid : this.players) {
      ...
      connection.a((Packet)new PacketPlayOutEntityEquipment(this.armorStand.ah(), list));
    } 
  }
  ...
  public void lookEntity() {
    ...
    for (UUID uuid : this.players) {
      ...
      connection.a((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.armorStand.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
      connection.a((Packet)new PacketPlayOutEntityHeadRotation((Entity)this.leashed, (byte)(int)(yaw * 256.0F / 360.0F)));
      connection.a((Packet)new PacketPlayOutEntity.PacketPlayOutEntityLook(this.leashed.ah(), (byte)(int)(yaw * 256.0F / 360.0F), (byte)0, true));
    } 
  }
