...
public class CustomSprayHandler extends CustomSpray {
  ...
  public CustomSprayHandler(Player player, Location location, BlockFace blockFace, ItemStack itemStack, MapView mapView, int rotation) {
    ...
    this.itemFrame = new EntityItemFrame(EntityTypes.V, (World)world);
  ...
  public void spawn(Player player) {
    ...
    entityPlayer.b.a((Packet)new PacketPlayOutSpawnEntity((Entity)this.itemFrame, this.enumDirection.d()));
    this.itemFrame.al().refresh(entityPlayer);
  ...
  public void remove(Player player) {
    ...
    connection.a((Packet)new PacketPlayOutEntityDestroy(new int[] { this.itemFrame.ah() }));
