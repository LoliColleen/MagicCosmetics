      ...
      synchronized (this) {
        ...
        if (result == null) {
          ...
          try {
            ...
            seal();
          } catch (com.zaxxer.hikari.pool.HikariPool.PoolInitializationException pie) {
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\zaxxer\hikari\HikariDataSource.class
