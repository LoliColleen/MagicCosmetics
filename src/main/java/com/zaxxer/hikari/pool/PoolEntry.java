...
final class PoolEntry implements ConcurrentBag.IConcurrentBagEntry {
  ...
  public String toString() {
    ...
    return "" + this.connection + ", accessed " + this.connection + " ago, " + 
      ClockSource.elapsedDisplayString(this.lastAccessed, now);
  }
...
/* Location:              D:\下载\MagicCosmetics-3.1.0[tinksp.com].jar!\com\zaxxer\hikari\pool\PoolEntry.class
